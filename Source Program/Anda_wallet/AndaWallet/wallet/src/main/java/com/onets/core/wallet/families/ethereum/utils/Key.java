...
public class Key {
    private String q;
    private String s;
    private final String g = "8U14GPFHQVKNADG8DQ3HW8QZ5TKK936G28";
    ...
    public Key(String s) {
        this.s = s;
        //todo: 打包apk到应用市场时修改此处的 “” ，防止接口滥用
        q = BuildConfig.FLAVOR.equals("") ? s : w(g, "JG634TZC90MJLKWO9JS1ZXGFAOPF89K2M2");
    }
