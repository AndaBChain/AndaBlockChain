package com.onets.core.coins.nxt;
...
public final class Convert {
    ...
    public static long parseAccountId(CoinType type, String account) {
        checkArgument(type instanceof EthereumFamily, "Unexpected type for an account");
        if (account == null) {
            return 0;
        }
    ...
    public static String rsAccount(CoinType type, long accountId) {
        checkArgument(type instanceof EthereumFamily, "Family must be Nxt");
