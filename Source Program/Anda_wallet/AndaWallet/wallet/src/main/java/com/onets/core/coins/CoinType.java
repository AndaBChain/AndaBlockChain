...
abstract public class CoinType extends NetworkParameters implements ValueType, Serializable {
    ...
    protected String name;//链名
    protected String symbol;//单位符号
    protected String uriScheme;//标识符
    protected Integer bip44Index;//bip44指数,BICOIN 0，ANDACHAIN 98， ETHEREUM 80
    protected Integer unitExponent;//小数点位数
    protected String addressPrefix;//地址前缀
    protected Value feeValue;//每笔交易费用
    ...
    @Override
    public com.onets.core.util.MonetaryFormat getPlainFormat() {
        if (plainFormat == null) {
