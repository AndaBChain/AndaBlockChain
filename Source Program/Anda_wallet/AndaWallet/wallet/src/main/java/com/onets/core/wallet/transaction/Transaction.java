...
public class Transaction {
    ...
    public Transaction(String sender, String sign, String recipient, byte[] publicKey, BigDecimal amount) {
        this.sender = sender;
        this.sign = sign;
    ...
    public Transaction(String sender, String recipient, byte[] publicKey, BigDecimal amount) {
        this.sender = sender;
        this.recipient = recipient;
        this.publicKey = publicKey;
        this.amount = amount;
    ...
    public String toString() {
        return "Transaction{" +
                "sender='" + sender + '\'' +
                ", recipient='" + recipient + '\'' +
                ", publicKey='" + HashUtil.toHexString(publicKey) + '\'' +
                ", amount=" + amount +
                ", timestamp=" + timestamp +
                ", txHash=" + txHash +
