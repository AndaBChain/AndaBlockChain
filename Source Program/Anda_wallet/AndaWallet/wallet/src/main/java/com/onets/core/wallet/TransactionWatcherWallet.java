...
import com.onets.core.util.BitAddressUtils;
import com.onets.core.wallet.families.bitcoin.BitAddress;
import com.onets.core.wallet.families.bitcoin.BitBlockchainConnection;
import com.onets.core.wallet.families.bitcoin.BitTransaction;
import com.onets.core.wallet.families.bitcoin.BitTransactionEventListener;
import com.onets.core.wallet.families.bitcoin.BitWalletTransaction;
...
abstract public class TransactionWatcherWallet extends AbstractWallet<BitTransaction, BitAddress>
    ...
    private static final String TAG = "TransactionWatcherWalle";
...
//        tx.getConfidence().addEventListener(txConfidenceListener, Threading.SAME_THREAD);
    ...
    public boolean broadcastTxSync(AbstractTransaction tx) throws TransactionBroadcastException {
        ...
        Log.d(TAG, "20189131624:" + getBalance());
        Log.d(TAG, "20189131624:" + getCoinType());
        if (tx instanceof BitTransaction) {
