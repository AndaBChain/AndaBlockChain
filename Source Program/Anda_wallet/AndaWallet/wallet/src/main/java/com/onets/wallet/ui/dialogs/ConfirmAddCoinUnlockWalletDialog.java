                ...
                .setPositiveButton(R.string.button_add, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (listener != null) {
                            ...
                            if (type instanceof BitcoinMain){
                                Constants.saveBitcoinPassword(getContext(), password.getText().toString());
                            }else if (type instanceof EthereumMain){
                                Constants.saveEthereumPassword(getContext(), password.getText().toString());
                            }else if (type instanceof RippleMain){
                                Constants.saveRipplePassword(getContext(), password.getText().toString());
                            }
                        }
                    }
                }).create();
