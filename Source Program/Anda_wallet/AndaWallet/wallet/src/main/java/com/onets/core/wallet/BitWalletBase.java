...
import static com.onets.core.util.BitAddressUtils.isP2SHAddress;
...
abstract public class BitWalletBase extends TransactionWatcherWallet implements KeyBag {
    ...
    private static final String TAG = "BitWalletBase";
    ...
    public void completeTransaction(BitSendRequest req) throws WalletAccountException {
        ...
        try {
            ...
            Log.d(TAG, Constants.LOG_LABLE + "handleSendConfirmB:completeTransaction: ");
