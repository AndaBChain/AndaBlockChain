...
package com.onets.wallet.Fragment_Chongzhi.widget.widget;
...
//        }
        ...
        private OnClickListener onMainViewClickOutListener;
        ...
        public OnClickListener getOnMainViewClickOutListener() {
            return onMainViewClickOutListener;
        }

        public void setOnMainViewClickOutListener(OnClickListener onMainViewClickOutListener) {
