...
import com.onets.stratumj.messages.BaseMessage;
import com.onets.stratumj.messages.CallMessage;
import com.onets.stratumj.messages.MessageException;
...
public class StratumClient extends AbstractExecutionThreadService {
    ...
    private final int NUM_OF_WORKERS = 1;//矿工人数

    private AtomicLong idCounter = new AtomicLong();//计数器
    private ServerAddress serverAddress;
    private Socket socket;
    @VisibleForTesting DataOutputStream toServer;//传送到服务器
    BufferedReader fromServer;//从服务器接收

    final private ExecutorService pool = Executors.newFixedThreadPool(NUM_OF_WORKERS);//矿池
