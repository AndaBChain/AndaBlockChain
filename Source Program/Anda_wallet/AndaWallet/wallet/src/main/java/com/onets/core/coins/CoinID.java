...
public enum CoinID {
    ...
    ANDACHAIN_MAIN(AndaChainMain.get()),
    ...
    static {
        Set<NetworkParameters> bitcoinNetworks = Networks.get();
        for (NetworkParameters bitcoinNetwork : bitcoinNetworks) {
            Networks.unregister(bitcoinNetwork);
        }
