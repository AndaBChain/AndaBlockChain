...
import com.onets.core.util.ExchangeRateBase;
...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    public static class ExchangeRate {
        ...
        public final String currencyCodeId;//货币代码
        @Nullable public final String source;//来源
    ...
    private JSONObject requestExchangeRatesJson(final URL url) {
        ...
        Log.e("----------", "requestExchangeRatesJson: url :"+ url );
