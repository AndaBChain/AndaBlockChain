    ...
    implements ASN1Choice
{
     ...
     * <li> {@link org.ripple.bouncycastle.asn1.ASN1OctetString#getInstance(Object) ASN1OctetString} input formats (OctetString, byte[]) with value of KeyIdentifier in DER form
