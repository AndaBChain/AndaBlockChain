 ...
 * you need, these should prove useful. You can get a confidence object using {@link org.bitcoinj.core.Transaction#getConfidence()}.
...
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * wallet has been attached to a live {@link org.bitcoinj.core.PeerGroup} using {@link PeerGroup#addWallet(Wallet)}.
    ...
    private org.bitcoinj.core.Transaction overridingTransaction;
    ...
    public boolean markBroadcastBy(PeerAddress address) {
        lastBroadcastedAt = org.bitcoinj.core.Utils.now();
     ...
     */
    public synchronized org.bitcoinj.core.Transaction getOverridingTransaction() {
