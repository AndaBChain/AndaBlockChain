...
public class FabConfig {
    ...
    private static final String testUser1 = "qqxa";
    private static final String adminPass = "adminpw";
    private static final String secret1 = "jiCHBJIpNKKk";
    ...
    private static final int INVOKEWAITTIME = 320000;
    private static final int DEPLOYWAITTIME = 3200000;
    private static final long PROPOSALWAITTIME = 3200000;
    ...
    private FabConfig() {
        ...
        yamlMap.forEach((orgName, orgMap) -> {
            ...
            if (runningFabricCATLS) {
                String cert = getTEST_FIXTURES_PATH() + "/sdkintegration/e2e-2Orgs/FAB_CONFIG_GEN_VERS/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem"
    ...
    protected String getChannelPath(){
        // this.getClass().getResource("/opt/gopath/src/github.com/hyperledger/demo/src/test/fixture/sdkintegration/e2e-2Orgs/" + FAB_CONFIG_GEN_VERS).getPath();
        // **==
        File file = new File(getTEST_FIXTURES_PATH()+"/sdkintegration/e2e-2Orgs/" + FAB_CONFIG_GEN_VERS);
        return file.getPath();
    }
